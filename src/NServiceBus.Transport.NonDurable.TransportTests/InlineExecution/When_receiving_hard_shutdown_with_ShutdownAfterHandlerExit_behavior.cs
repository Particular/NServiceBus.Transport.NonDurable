...
[TestFixture]
public class When_receiving_hard_shutdown_with_ShutdownAfterHandlerExit_behavior
{
    [Test]
    public async Task Should_interrupt_in_flight_handler_and_requeue_envelope()
    {
